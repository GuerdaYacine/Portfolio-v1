    ...
    <section class="flex items-center justify-center flex-grow px-4">
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-8 py-16">
            ...
            <div class="w-full lg:w-1/2 text-center lg:text-left">
                <h2 class="text-[2.8rem] font-extrabold text-[#145C9E] mb-6" id="error-title">Une erreur est survenue</h2>

                <p class="text-[1.8rem] font-semibold opacity-90 mb-8" id="error-message">
                    Nous rencontrons un problème. Veuillez réessayer plus tard ou revenir à la page d'accueil.
                </p>

                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <a href="/" class="px-8 py-3 bg-[#145C9E] text-white rounded-md font-semibold text-lg hover:bg-[#0f4c81] transition-colors duration-300">
